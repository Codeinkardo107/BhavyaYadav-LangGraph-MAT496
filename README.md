...
### 3) map-reduce.ipynb
This notebook demonstrates the map-reduce pattern, where data is split across multiple nodes for parallel processing and then combined to produce a final aggregated result.
